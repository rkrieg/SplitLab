      ...
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-bold text-white">Split<span className="text-blue-400">Lab</span></span>
          </div>
        </div>
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          Questions? <a href="mailto:support@splitlab.io" className="text-slate-500 hover:text-slate-300">support@splitlab.io</a>
        </p>
      </div>
    </div>
  );
