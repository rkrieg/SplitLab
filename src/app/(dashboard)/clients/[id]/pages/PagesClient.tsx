      ...
      {tests.length === 0 && (
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/50 p-10 text-center my-6">
          <div className="w-14 h-14 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center mx-auto mb-5">
            <FileCode2 size={28} className="text-indigo-500 dark:text-indigo-400" />
          </div>
                  ...
                  <div className="flex items-center gap-4 ml-4 flex-shrink-0">
                    ...
                    {canManage && (
                      <div className="relative">
                        ...
                        {activeMenu === test.id && (
                          <div onClick={(e) => e.stopPropagation()} className="absolute right-0 top-full mt-1 w-44 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-xl z-10 overflow-hidden">
                            {test.status === 'draft' && (
